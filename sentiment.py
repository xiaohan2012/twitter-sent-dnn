...
WORD2INDEX = load(open("dnnsent/data/twitter.pkl", "rb"), encoding="latin1")[3]
PADDING_INDEX = WORD2INDEX["<PADDING>"]

from .param_util import load_dcnn_model_params
from .dcnn import DCNN

params = load_dcnn_model_params(
    "dnnsent/models/filter_widths=8,6,,batch_size=10,,ks=20,8,,fold=1,1,,conv_layer_n=2,,ebd_dm=48,,l2_regs=1e-06,1e-06,1e-06,0.0001,,dr=0.5,0.5,,nkerns=7,12.pkl")
